...
class RescaleTransform:
    ...
    def __call__(self, image):
        assert type(
            image) == np.ndarray, "The input image needs to be a numpy array! Make sure you dont send the string path."
        ret_image = None
        ########################################################################
        # TODO:                                                                #
        ...
        ########################################################################
        ret_image = (image - self._data_min) / (self._data_max -
                                                self._data_min) * (self.max - self.min) + self.min
        ########################################################################
        return ret_image
